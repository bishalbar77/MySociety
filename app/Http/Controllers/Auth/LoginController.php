...
class LoginController extends Controller
{
    ...
    */
    ...
    public function loginProcess(Request $request)
    {
        ...
        $response = Http::post('https://api.mysociety.com/api/login-by-email', [
            'email' => $email,
            'password' => $password,
            'api_key' => $apiKeys,
        ]);
    ...
    public function sendotp(Request $request)
    {
        try 
        {
            ...
            $response = Http::post('https://api.mysociety.com/api/send-otp', [
                'mobile' => $mobile,
                'device_id' => $device_id,
                'api_key' => $apiKeys,
            ]);
    ...
    public function checkotp(Request $request)
    {
        try 
        {
            ...
            $response = Http::post('https://api.mysociety.com/api/verify-otp', [
                'mobile' => $mobile,
                'otp' => $otp,
                'device_id' => $device_id,
                'api_key' => $apiKeys,
