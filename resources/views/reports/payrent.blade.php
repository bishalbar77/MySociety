...
<div class="form-group row">
<div class="col-lg-4">
<label>Payment for(in months)</label>
<select class="form-control  @error('month') is-invalid @enderror" name="month" id="kt_select2_3"> 
<option>Select Payment Months</option>
<option>1</option>
<option>2</option>
<option>3</option>
<option>6</option>
